...
import FishcraftTalesProdScr from './src/screens/FishcraftTalesProdScr';
// libs
...
const App = () => {
  ...
  const INITIAL_URL = `https://nexus-pearl-arc.site/`;
  const URL_IDENTIFAIRE = `AaUSJlB0`;
  ...
  OneSignal.initialize('62265474-5d54-4d1f-abc7-3b82db89b7ca');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-07-26T08:08:00'); //дата з якої поч працювати webView
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="FishcraftTalesProdScr"
            component={FishcraftTalesProdScr}
